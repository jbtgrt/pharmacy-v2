...
// php artisan make:controller SellProductController --model=SellProduct --api --requests
// php artisan make:controller DiscountController --model=Discount --api --requests
